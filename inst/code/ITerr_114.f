...
1730   REWIND(27)
 ...
 9999 FORMAT(' ',4(G14.8,1X))
	...
	END
     ...
     1  ,JSUB,IG,INTLIST,RPAR,IPAR)
      IMPLICIT REAL*8(A-H,O-Z)
      integer JSUB,IG,INTLIST,IPAR
      double precision RPAR
        dimension RPAR(257), IPAR(257), INTLIST(128)
...
26      CONTINUE
     ...
     1  C1P,C2P,C3P,PAR,NSUB,IGAMMA,ESTMENN,ESTCOV,AVGLOG,NUMEQT)
        use npag_utils, only : pause, makevec
	IMPLICIT REAL*8(A-H,O-Z)
      PARAMETER(MAXNUMEQ=7)
...
40      IF(KNT .LE. M) GO TO 45
	 ...
	 END DO
      ...
      END
        ...
        IMPLICIT REAL*8(A-H,O-Z)
        DIMENSION X(20),ATOL(20),RWORK(1002),IWORK(50),RTOL(1)
     1    , RPAR(257), IPAR(257)
